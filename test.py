...
val_annopath = "data\\coco\\annotations\\coco_val_v1.0.json"
val_imagepath = "data\\coco\\val2017"
val_dataset = COCODataset(val_annopath, val_imagepath, transforms=transforms.Compose([transforms.ToTensor(), normalize]),
